...
<body>
  <head>
    ...
    <title>Minh Khánh PC - Danh mục sản phẩm</title>
    <?php 
            ...
            <div class="section" style="margin-bottom: 100px;">
              <div class="col unglow">
                <ul id="filter_dropdown" class="dropdown-content black">
                  <li><a class="cyan-text page-title" onclick="select_category(this)">Xoá</a></li>
                  <li><a class="cyan-text page-title" onclick="select_category(this)">PC</a></li>
                  <li><a class="cyan-text page-title" onclick="select_category(this)">Tai Nghe & Màn Hình</a></li>
                  <li><a class="cyan-text page-title" onclick="select_category(this)">Gaming Gear</a></li>
                </ul>
            ...
            <div class="section" style="margin-bottom: 100px">
              <div class="col unglow">
                <ul id="sort_dropdown" class="dropdown-content black">
                  <li><a class="page-title" onclick="select_sort(this)">Xoá</a></li>
                  <li><a class="page-title" onclick="select_sort(this)">Giá từ thấp đến cao</a></li>
                  <li><a class="page-title" onclick="select_sort(this)">Giá từ cao đến thấp</a></li>
                </ul>
            ...
            <div class="section">
              <div class="col unglow">
                <ul id="choose_dropdown" class="dropdown-content black">
                  <li><a class="cyan-text page-title" onclick="select_brand(this)">Xoá</a></li>
...
<script>
  ...
  var sortBy = {
    "Xoá": -1,
    "Giá từ thấp đến cao": 0,
    "Giá từ cao đến thấp": 1
  };
