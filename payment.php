...
<head>
  ...
  <title>Minh Khánh PC - Payment</title>
  <?php 
    include "header.php"; 
...
<body>
  <div class="container">
    ...
    <div class="selectable-card grey darken-4" id="no-hover">
      <div class="row">
        <h4 class="orange-text bold" style="padding-top: 10px;"> Thanh Toán</h4>
      </div>
        ...
        <div class="col s8">
          <div class="row">
            <div class="input-field col s6">
              ...
              <label class="active cyan-text" for="name">Tên Chủ Thẻ</label>
            ...
            <div class="input-field col s6">
              ...
              <label class="active cyan-text" for="card_number">Số Thẻ</label>
          ...
          <div class="row">
            <div class="input-field col s4">
              ...
              <label for="exp_month">Tháng hết hạn</label>
            ...
            <div class="input-field col s4">
              ...
              <label for="exp_year">Năm hết hạn</label>
          ...
          <div class="row">
            <div class="input-field">
              ...
              <textarea placeholder="Số nhà, Đường, Quận, Zip, Thành Phố" id="home"
                class="materialize-textarea white-text"
                name="address" type="text" class="validate white-text"></textarea>
              <label class="active cyan-text" for="home">Địa chỉ thanh toán</label>
        ...
        <div class="col s4">
          <div class="rounded-card tint-glass-black" style="margin-top: 100px;">
            <div class="card-content">
              <label class="bold white-text" style="font-size: 24px;">Thẻ được chấp nhận</label>
