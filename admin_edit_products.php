...
<head>
  ...
  <title>Minh Khánh PC - Chỉnh Sửa Sản Phẩm</title>
  <?php
    require "header.php";
...
<body>
  ...
  <div class="card rounded-card">
    <a class="btn blue darken-2" href='admin_manage_products.php' style="margin-bottom: 10px;">< QUAY LẠI QUẢN LÝ SẢN PHẨM</a>
    <span class="card-title orange-text bold center" style="padding-left: 100px;">Chỉnh Sửa Sản Phẩm - <?php echo $name; ?></span>
          ...
          <div class="row">
            <div class="input-field white-text">
              ...
              <select name="category" id="category">
                <option value="" disabled selected>Tuỳ Chọn</option>
                <option value=0>PC </option>
                <option value=1>Tai Nghe & Loa</option>
                <option value=2>Gaming Gear</option>
              </select>
              <label class="white-text">Sản Phẩm</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field white-text">
    ...
    <button type="submit" id="update" name="update" class="btn">Cập Nhật Sản Phẩm</button>
    </form>
  </div>
</div>
</body>
