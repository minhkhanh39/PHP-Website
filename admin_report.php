...
<div class="container" style="margin-top:150px">
	...
	<div class="rounded-card-parent center" style="margin-bottom:20px">
		<h5 style="color:white">Biểu đồ bán hàng</h5>
		<p style="color:white">Biểu đồ bán hàng so với tuần</p>
		<div>
		...
		<h4 style="color:white">Tổng doanh số trong 7 ngày qua: VNĐ<?php echo $data_tot = number_format((float)$data_tot, 2, '.', '');?></h4>
		<h4 style="color:white">Ngày bắt đầu: <?php echo $date7?></h4>
		<h4 style="color:white">Ngày cuối: <?php echo $date1?></h4>
	</div>
	<br><br><br>
	<h3 class="page-title">Báo cáo hàng tháng</h3>
	<div class="rounded-card-parent center" style="margin-bottom:20px">
		<h5 style="color:white">Biểu đồ bán hàng</h5>
		<p style="color:white">Biểu đồ doanh số so với tháng</p>
		<div>
		...
		?>
		<h4 style="color:white">Tổng doanh thu trong 90 ngày qua: VNĐ<?php echo $month_tot = number_format((float)$month_tot, 2, '.', '');?></h4>
	</div>
	<br><br><br>
	<div class="row" id="product" name="product"></div>
	<h3 class="page-title">Báo cáo mục</h3>
	<div class="rounded-card-parent center" style="margin-bottom:20px">
		<h5 style="color:white">Biểu đồ các mục</h5>
		<p style="color:white">Số lượng hàng tồn kho từng loại</p>
		<div>
	...
	<h3 class="page-title">Báo cáo người dùng</h3>
	<div class="rounded-card-parent center" style="margin-bottom:20px">
		<h5 style="color:white">Biểu đồ thanh người dùng</h5>
		<p style="color:white">Đăng ký mới trong 30 ngày gần đây</p>
		<div>
...
Số lượng đăng ký mới trong 30 ngày qua:<?php echo $quantity_user?> user/users</h4>
	</div>
</div>
<script>
