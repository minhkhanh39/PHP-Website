...
<head>
  ...
  <title>Minh Khánh - Manage Users Panel</title>
  <?php
    include "header.php"; 
  ...
  <div class="container" style="margin-top: 150px">
    ...
    <div class="rounded-card-parent center" style="margin-bottom: 100px">
      <div class="card rounded-card">
        <div class="card-content white-text">
          <span class="card-title orange-text bold">Danh sách người dùng - Sắp xếp theo mới nhất
          ...
          <form id="search_user" action="admin_manage_users.php" method="POST">
            <div class="row" style="margin: 0px;">
              <div class="input-field col s3" style = "color:azure">
                ...
                <label for="search_member">Tìm kiếm thành viên theo tên</label>
                <div class="errormsg">
                  <?php
                    if (isset($_GET["error"]))
                    {
    ...
    <?php if (isset($_GET["inspect"])) { ?>
      <div class="rounded-card-parent center">
        <div class="card rounded-card">
          <div class="card-content white-text">
            <span class="card-title orange-text bold">Chi tiết thành viên đã chọn</span>
            <table class="responsive-table">
              <form action="admin_manage_users.php" method="GET">
                <thead class="text-primary center">
                  <tr><th>Mã thành viên</th><th>Tên tài khoản</th><th>Email</th><th>Cấp độ đặc quyền</th></tr>
                </thead>
                <tbody>
    ...
    <div class="rounded-card-parent" style="margin-top: 100px">
      <div class="card rounded-card">
        <div class="card-content">
          <span class="card-title orange-text bold">Tạo người dùng</span>
          <form id="create" name="create" action="" method="post">
            <div class="row">
              <div class="input-field col s8 white-text">
                ...
                <label for="username" class="white-text"> Tên</label>
              </div>
            </div>
            <div class="row">
              <div class="input-field col s8 white-text">
            ...
            <div class="row">
              <div class="input-field col s8 white-text">
                ...
                <label for="repeat_pwd" class="white-text"> Lặp lại mật khẩu</label>
              </div>
            </div>
            <div class="row">
              <div class="input-field col s8 white-text">
                ...
                <select id="level" name="level">
                  <option value="" disabled selected>Chọn tùy chọn của bạn</option>
                  <option value=1>Thành viên</option>
                  <option value=2>Quản trị viên</option>
                </select>
                <label class="white-text">Cấp độ đặc quyền</label>
              </div>
            </div>
            <div class="row">
              <div class="input-field col s8 white-text">
