      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <?php
          ...
          <?php if ($privilegeLevel == 1)
            echo("<li><a class='admin admin_manage_users admin_view_orders' href='admin.php' target='_blank'>Quản lý</a></li>");
          echo
            ("
            <li>
              <a class='cart' href='cart.php?member_id=$memberID'>
                Giỏ Hàng<span class='new badge unglow' id='cart_badge'>$orderItemCount</span></a>
            </li>
            <li><a class='manage_profile' href='manage_profile.php?email=$email'>Quản Lý Thông Tin</a></li>
            <li><a href='includes/logout.inc.php'>Đăng Xuất</a></li>
            ");
          } else
          {
            echo(
              ...
              <li><a class='signup' href='signup.php'>Đăng Ký</a></li>
            ");
          }
          ?>
      </ul>
