...
<head>
  ...
  ?>
  <title>Minh Khánh PC — <?php echo htmlspecialchars($name) ?></title>
</head>
<body>
  ...
  <?php 
    if (isset($_GET["item_id"])){
      ...
      $displayPrice = number_format($price, 2) . " VNĐ " ;
...
<div class="container" style="margin-top: 50px;">
  <div class="rounded-card-parent">
    <div class="card rounded-card">
      <a class="btn red darken-2" href="product_catalogue.php?query=" style='margin-left: 20px'>< Trở về mục lục</a>
        ...
        <div class="row">
          ...
          <div class="col s8">
            <div class="row">
              <table class="responsive-table">
                <tbody>
                  ...
                  <tr><th class='grey-text'>Thương hiệu: </th><td><?php echo($brand); ?></td></tr>
                  <tr><th class='grey-text'>Mô tả: </th>
                    <td>
                      <?php 
                  ...
                  <tr><th class='grey-text'>Loại: </th><td><?php echo($category); ?></td></tr>
                </tbody>
              </table>
            </div>

            <div class="row input-field grid">
              <a style="margin-right: 10px"><p class="grey-text">Số lượng:</p></a>          
            ...
            <div class="row grid" style="margin-right: 10px">
              ...
              <input class="btn white-text waves-effect amber darken-4" type="submit" name="buy_now" style='margin-left: 10px' value="Mua Ngay">
            </div>
          </div>
        </div>
      </form>
  ...
  <div class="rounded-card-parent" style="margin-top: 50px;">
    <div class="card rounded-card">
      <h4 class="white-text" style="margin-bottom: 40px;">Xem trước</h4>
      ...
      <?php
        ...
        } else echo("<h6 class='grey-text'>Chưa có đánh giá nào... Hãy là người đầu tiên để lại đánh giá!</h6>")
      ?>
    </div>
  </div>
</div>
