...
<head>
  ...
  <title>Đưa ra đánh giá của bạn</title>
  <?php
    include "header.php";
        ...
        <div class="row">
          <div class="col s9">
            <div class="grid left">
              ...
              <h4 class="amber-text bold grid">Đánh giá sản phẩm</h4>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="row">
            ...
            <?php
              ...
              {
                if ($_GET["error"] == "none")
                  echo "<p style='color: green; font-weight: bold'>Cảm ơn đã đánh giá! Đang chuyển hướng đến trang giỏ hàng...</p>";
              }
            ?>
          </div>
