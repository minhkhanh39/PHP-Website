...
<head>
  ...
  <title>Minh Khánh - QUẢN LÝ</title>
  <?php 
    include "header.php";
        ...
        <div class="col s12 m6">
          <div class="card blue darken-1" style="width: 340px;">
            ...
            <div class="card-action left" style="width: 340px;">
              <a href="admin_report.php#user">Xem Thóng Báo</a>
              <a href="admin_manage_users.php">Quản Lý Người Dùng</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style="width: 340px; height: 238px">
        <div class="col s12 m6">
          <div class="card amber darken-4" style="width: 340px;"> 
            ...
            <div class="card-action left" style="width: 340px;">
              <a href="admin_report.php#product">Xem Thông Báo</a>
      ...
      <div style="width: 340px; height: 238px">
        <div class="col s12 m6">
          <div class="card green darken-1" style="width: 340px;">
            ...
            <div class="card-action left" style="width: 340px;">
              <a href="admin_report.php#order">Xem Thông Báo</a>
              <a href="admin_view_orders.php">Quản Lý Đơn Hàng</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col s12 m6">
          <div class="card red lighten-1" style="width: 340px;">
            ...
            <div class="card-action center">
              <a href="admin_view_orders.php">Quản Lý</a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-content white-text">
              <table class="responsive-table center" id="pagination">
                <thead class="text-primary center">
                  <tr>
                    <h5 class="white-text bold" style="padding-bottom: 20px">Đánh Giá Sản Phẩm</h5>
                  </tr>
                </thead>
                <tbody>
                  <?php 
