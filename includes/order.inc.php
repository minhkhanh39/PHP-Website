  ...
  if (!$view_order)
  {
    echo(
      "<button class='btn red darken-4 col s2' style='padding: 0px; margin: 0px;'
        ...
        onclick=\"return confirm('Bạn có muốn xoá \'$itemName\'?');\">
        Xoá
      </button>"
    );
  }
      ...
      <div class='rounded-card-parent'>
        <div class='card rounded-card tint-glass-brown'>
          <div class='card-content white-text'>
            <h5 class='bold center'>Chi tiết đặt hàng</h5>
            <table class='responsive-table'>
              <tbody>
                <tr><th>Tổng số mặt hàng:</th><td class='left'>$totalItems</td></tr>");
                ...
                echo("<tr><th>Trạng thái:</th><td>Đã giao hàng (kiểm tra email để biết trạng thái)</td></tr>
              </tbody>
            </table>
          </div>
        </div>
